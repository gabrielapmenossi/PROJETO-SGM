...
<head>
    ...
    <style>
        ...
        body {
            ...
            margin: 0;
            padding: 0;
            min-width: 0 !important; /* Quebra as restrições de largura do style.css original */
        }
...
<body class="portal-gestor">
    ...
    <main>
        <div class="configurarambiente">
            <div class="a">
                <h2 class="text-center" style="margin-bottom: 20px;">Criar Tipos de Serviço</h2>
                <hr style="margin-bottom: 20px;">
                <form id="formTiposServico">
                    <div class="triagens">
                        <label>Tipo de Serviço</label>
                        <input type="text" id="nomeTipo" class="form-control" required>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            form.addEventListener('submit', async (e) => {
                ...
                const descricao = document.getElementById('descricaoTipo').value.trim();
                ...
                try {
                    ...
                    if(resposta.success){
                        ...
                        btnCriar.innerText = "Criar Tipo de Serviço";
                    }
