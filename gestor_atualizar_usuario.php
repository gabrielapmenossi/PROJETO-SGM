...
<head>
    ...
    <style>
        ...
        .a {
            ...
            width: 100%;
            max-width: 500px; /* Um pouco mais largo para acomodar o select longo */
        }
...
<body class="portal-gestor">
            ...
            <div class="a">
                ...
                <form id="formUsuarios">
                    ...
                    <div class="triagens">
                        ...
                        <input type="text" id="nomeUsuario" class="form-control" placeholder="Nome do usuário" required>
                    </div>

                    <div class="triagens">
                        <label for="emailUsuario">Email</label>
                        <input type="email" id="emailUsuario" class="form-control" placeholder="exemplo@email.com" required>
                    </div>
                    ...
                    <button type="submit" class="confirmar" id="btnAtualizar">Atualizar Usuário</button>
                </form>
            </div>
        </div>
    </main>
    ...
    <script>
        ...
        // 2. PREENCHER CAMPOS AO SELECIONAR
        ...
        document.getElementById('formUsuarios').addEventListener('submit', async function(e){
            ...
            if(!id_usuario || !nome || !email || !perfil){
            ...
            try {
                const res = await fetch('./api/api_usuarios.php', {
                    ...
                    body: JSON.stringify({ id_usuario, nome, email, perfil })
                });
                ...
                if(resposta.success){
                    ...
                    btn.disabled = false;
                    btn.innerText = 'Atualizar Usuário';
                }
            } catch(error){
                console.error(error);
